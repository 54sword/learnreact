...
class MyEditor extends React.Component {
  ...
  constructor(props) {
    ...
    const { syncContent, readOnly, content } = this.props

// console.log(content)

// EditorState.createWithContent(this.state.content, decorator)

    this.state = {
      content: content ? convertFromRaw(JSON.parse(content)) : '',
  ...
  render() {
    ...
    */
    ...
    /*
      return (<div styleName="draft">
              <Editor
                blockRendererFn={mediaBlockRenderer}
                editorState={EditorState.createWithContent(this.state.content, decorator)}
    ...
    return (<div>
      <div styleName="draft" className={className}>
        ...
        <div>
          ...
          <button onMouseDown={this.addVideo} style={{marginRight: 10}}>添加视频</button>
        </div>
